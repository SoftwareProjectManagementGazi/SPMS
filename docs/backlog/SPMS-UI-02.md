# Backlog Task: SPMS-UI-02

**Kategori:** 1.3.2 Kullanıcı Arayüzü Gereksinimleri
**İster:** Sürükle-bırak destekli görev panosu (Kanban) ve durum bildirimleri

## Görev Tanımı
SRS dokümanında belirtilen `SPMS-UI-02` kodlu isterin, `sdd.md` dokümanındaki kararlara (örneğin tablo adlandırmaları, algoritmik sınırlar) ve Clean Architecture standartlarına tam uyumlu entegre edilmesi sağlanacaktır.
