# Backlog Task: SPMS-02.12

**Kategori:** 1.2.2 Proje ve Görev Yönetim Modülü (SPMS-02)
**İster:** Takvim görünümünde veya zaman çizelgesinde (Gantt) izleme

## Görev Tanımı
SRS dokümanında belirtilen `SPMS-02.12` kodlu isterin, `sdd.md` dokümanındaki kararlara (örneğin tablo adlandırmaları, algoritmik sınırlar) ve Clean Architecture standartlarına tam uyumlu entegre edilmesi sağlanacaktır.
...
### 🟢 1. Domain Katmanı
- Model: `TimelineReadModel`. Process modülünden kuralları alır.

### 🟡 2. Application Katmanı
- UseCases: `GetProjectTimelineQuery`.

### 🔴 3. Infrastructure Katmanı
- Repository: `SqlAlchemyTaskRepository` (başlangıç/bitiş tarihleri çekilir).
