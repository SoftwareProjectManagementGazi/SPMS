# Backlog Task: SPMS-DATA-7

**Kategori:** 1.5 SPMS Dahili Veri Gereksinimleri
**İster:** Yumuşak silme (Soft delete)

## Görev Tanımı
SRS dokümanında belirtilen `SPMS-DATA-7` kodlu isterin, `sdd.md` dokümanındaki kararlara (örneğin tablo adlandırmaları, algoritmik sınırlar) ve Clean Architecture standartlarına tam uyumlu entegre edilmesi sağlanacaktır.
