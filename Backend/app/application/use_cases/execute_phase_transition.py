...
class ExecutePhaseTransitionUseCase:
    ...
    async def execute(
        ...
        # lazy normalizer migrates legacy V1 dicts on load, so all reads here see
        # the V2 key. (C3: removed the V1-alias fallback once all test fixtures
        # were migrated to V2 shape.)
