...
| `Frontend2/components/admin/users/user-row-actions.tsx` (NEW) | component | RW | `Frontend2/components/admin/shared/more-menu.tsx` (Plan 14-01 Wave 0) — produced once, consumed in 5 sites (Users, Projects, Templates, Pending request, Audit) | Imports shared MoreMenu from Plan 14-01 (`@/components/admin/shared/more-menu`) — DO NOT rebuild. Wires per-row item handlers. | Realized recommendation: shared `Frontend2/components/admin/shared/more-menu.tsx` ships in Plan 14-01 Wave 0. |
...
| `Frontend2/components/admin/shared/more-menu.tsx` (Plan 14-01 Wave 0) | reusable MoreH dropdown — produced once, consumed in 5 admin tables | RESEARCH §Don't Hand-Roll line 830 — realized in Plan 14-01 Task 1 Step 6.5 | `Frontend2/components/projects/project-card.tsx` lines 167–197 (donor source) |
