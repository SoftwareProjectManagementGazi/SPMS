...
| Property | Value |
|----------|-------|
| **Framework** | None detected in Frontend/ — using `next build` as type-check proxy |
...
- **After every plan wave:** Run `cd Frontend && npx next build` + manual visual comparison with prototype
...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 08-01-01 | 01 | 1 | FOUND-01 | — | N/A | build | `cd Frontend && npx next build` | ✅ | ⬜ pending |
| 08-01-02 | 01 | 1 | FOUND-04 | — | N/A | grep | `grep "status-todo\|status-blocked" Frontend/app/globals.css` | ✅ | ⬜ pending |
| 08-02-01 | 02 | 1 | FOUND-02 | — | N/A | build | `cd Frontend && npx next build` | ✅ | ⬜ pending |
| 08-03-01 | 03 | 1 | FOUND-03 | — | N/A | build | `cd Frontend && npx next build` | ✅ | ⬜ pending |
| 08-04-01 | 04 | 2 | FOUND-05 | — | N/A | build+visual | `cd Frontend && npx next build` | ✅ | ⬜ pending |
...
| Dark mode toggle | FOUND-01 | Requires visual inspection | Toggle dark mode, verify both prototype and shadcn components style correctly |
