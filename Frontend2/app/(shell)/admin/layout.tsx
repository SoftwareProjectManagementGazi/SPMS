...
//   - "Rapor al" → downloadAuthenticated(`${API_BASE_URL}/admin/summary.pdf`,
...
//     reaches the backend (UAT gap-truth #2). The full backend URL is
//     constructed here (mirroring adminUserService.exportCsv() / admin
//     AuditService.exportJsonUrl()) — without the NEXT_PUBLIC_API_URL prefix
//     the request hits Next.js dev (localhost:3000) which has no API route
//     and 404s.
