...
// Tokens that can be tweaked via Tweaks panel: everything in the :root.
...
window.SPMSTheme = { PRESETS, deriveFromBrand, applyTokens, applyMode, applyRadius, resolvePreset, estimateContrast };
